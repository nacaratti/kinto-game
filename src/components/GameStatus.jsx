...
import { buildShareText, buildChallengeText, buildSocialShareUrl } from '@/lib/shareText';
...
const GameStatus = ({
  ...
  const shareSocial = (network) => {
    const url = buildSocialShareUrl(network, { text: buildShareTextLocal(), url: gameUrl });
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 bg-black hover:bg-zinc-800 border border-zinc-700 text-white font-semibold py-2.5 rounded-xl transition-colors text-xs"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 bg-[#0A66C2] hover:bg-[#08529b] text-white font-semibold py-2.5 rounded-xl transition-colors text-xs"
                >
                  <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor" aria-hidden="true">
